...
public class NotCorrectInputLoginAndPassword {
...
*/
    ...
    public void notCorrectInputLoginAndPassword () {
        driver.get("https://idemo.bspb.ru/auth?response_type=code&client_id=1&" +
